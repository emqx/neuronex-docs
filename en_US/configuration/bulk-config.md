...
Check the per-instance limits before configuring in bulk — see [Data Collection and Forwarding · Configuration specification](./introduction.md#configuration-specification).

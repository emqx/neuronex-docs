...
| Software         | EMQX Neuron            | TwinCAT 3           |
| Network          | Connected         | Connected           |

## Configure TwinCAT

Before EMQX Neuron and the TwinCAT PLC can communicate with each other, we first need to add a static route for EMQX Neuron in TwinCAT. We also need to find the AMS Net ID of the TwinCAT PLC and the index group and index offset of the variables.
...
3. Provide the information as highlighted in the following image. Note that the
   **AmsNetId** is the IP address of the EMQX Neuron PC appended with ".1.1".
...
In the EMQX Neuron dashboard, click **South Devices -> Add Device** to add an ADS node.

<figure align="center">
  <img src="./assets/add-driver.png" style="border:thin solid #E0DCD9; width: 60%" alt="Add ADS south device in EMQX Neuron dashboard">
  <figcaption align = "center">
    <sub><b>Fig.13 - Add ADS south device in EMQX Neuron dashboard</b></sub>
  </figcaption>
</figure>
...
<figure align="center">
  <img src="./assets/driver-setting.png" style="border:thin solid #E0DCD9; width: 60%" alt="Configure ADS node in EMQX Neuron dashboard">
  <figcaption align = "center">
    <sub><b>Fig.14 - Configure ADS node in EMQX Neuron dashboard</b></sub>
  </figcaption>
</figure>
...
corresponding tag to the EMQX Neuron ADS node. The [Beckhoff data types] page lists
...
<figure align="center">
  <img src="./assets/tag-list.png" style="border:thin solid #E0DCD9; width: 60%" alt="EMQX Neuron version 2.3.0 upload topic setting">
  <figcaption align = "center">
...
In the EMQX Neuron dashboard, click **Monitoring -> Data Monitoring**, check whether the tag values are read correctly.

<figure align="center">
  <img src="./assets/monitor-2.png" style="border:thin solid #E0DCD9; width: 60%" alt="EMQX Neuron data monitoring tab">
  <figcaption align = "center">
    <sub><b>Fig.19 - EMQX Neuron data monitoring tab</b></sub>
  </figcaption>
</figure>

### Write Tags

In the EMQX Neuron **Data Monitoring** tab, click **Write** on the *main.MXtest1* tag to write a true value.

<figure align="center">
  <img src="./assets/control-1.png" style="border:thin solid #E0DCD9; width: 60%" alt="EMQX Neuron write main.MXtest1">
  <figcaption align = "center">
    <sub><b>Fig.20 - EMQX Neuron write main.MXtest1</b></sub>
  </figcaption>
</figure>
...
<figure align="center">
  <img src="./assets/control-2.png" style="border:thin solid #E0DCD9; width: 60%" alt="EMQX Neuron write main.MWtest1">
  <figcaption align = "center">
    <sub><b>Fig.21 - EMQX Neuron write main.MWtest1</b></sub>
  </figcaption>
</figure>

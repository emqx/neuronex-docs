...
In **Data Collection -> South Devices**, click **Add Device** to create a device node, enter the driver name, and select **IEC60870-5-101** as the driver type to enable the driver.

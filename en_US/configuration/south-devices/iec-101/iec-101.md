...
In **Data Collection -> South Devices**, click **Add Device** to create a device node, enter the plugin name, and select **IEC60870-5-101** as the plugin type to enable the plugin.
...
After adding and configuring the plugin, you need to establish communication between the device and EMQX Neuron by adding groups and points to the southbound driver.

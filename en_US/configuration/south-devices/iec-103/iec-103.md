...
In **Data Collection -> South Devices**, click **Add Device** to create a device node. Enter the device name and select the plugin as **IEC 60870-5-103** to start the plugin.

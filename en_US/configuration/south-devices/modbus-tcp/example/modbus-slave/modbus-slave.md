# Modbus Slave Simulator Connection Example (TCP)
...
## Connect EMQX Neuron (Client)

This section mainly describes the configuration of EMQX Neuron and Modbus Slave when EMQX Neuron serves as Client and Modbus Slave serves as Server.

As a Client, EMQX Neuron initiates connection requests to Modbus Slave actively. The user needs to ensure the network connectivity of EMQX Neuron -> Modbus Slave.

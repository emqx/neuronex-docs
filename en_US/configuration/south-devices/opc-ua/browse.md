...
EMQX Neuron integrates the Address Space Browser function for OPC UA servers, which helps users to get the tags information in the connected OPC UA servers, including the tag's location information in the server model, the tag's access address, and the tag's type information. The tags can be quickly added to the collection group.
...
4. Select one or more data tags in the OPC UA address space and click the **Add Tags to Group** button to add these tags to the collection group. You can choose an existing group or create a new one. Up to 10000 tags can be added at a time.

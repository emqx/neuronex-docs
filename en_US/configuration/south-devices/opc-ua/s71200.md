...
This section introduces how to leverage Nuron OPC UA driver to connect S7-1200.
...
2. EMQX Neuron adds a new southbound OPC UA device, open **Device Configuration**, fill in the **Endpoint URL** of the target PLC, user name/password, no need to add certificate/key.
...
4. Add **Groups** and **Tags** based on the measurement point information.
   ...
   :::tip
   The **NODEID** of the Siemens S7-1200 is in digital form and the address of the EMQX Neuron needs to be set according to the actual value.
   :::

   The data type mapping relation is as follows:

   | PLC Data Type | OPC UA Data Type | EMQX Neuron Data Type |
   | ------------ | -------------- | --------------- |

# Siemens S7-300 PLC Connection Example
...
This section describes how to connect the S7300 via the EMQX Neuron Siemens MPI driver.
...
1. Add a Siemens MPI device to the EMQX Neuron Southbound Device Manager. 2.

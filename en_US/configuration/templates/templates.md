...
To add a group to the template, it is pretty much the same as that in [Groups and Tags](../groups-tags/groups-tags.md). Here, we add a group named *grp* with an interval of *3000*.
...
Click **Data Collection -> South Devices -> Add Device** to open the **New Device** dialog.

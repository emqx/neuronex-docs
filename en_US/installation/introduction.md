...
**The following table lists the hardware conditions required for the minimum demand of EMQX Neuron at different number of tags.(Using the data processing engine consumes additional system resources.)**

...
EMQX Neuron data processing module can receive data from `Redis` source.
::: tip
...
Log in to EMQX Neuron and click **Data Processing** -> **Sources**. On the **Lookup Table** tab, click **Create Lookup Table**.

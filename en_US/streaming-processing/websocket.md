...
The EMQX Neuron data processing module acquires data via the Websocket data source.
...
A Websocket data source can also act as a Websocket server. In this case, a remote Websocket client can actively initiate a Websocket connection to EMQX Neuron, and EMQX Neuron will receive messages over that Websocket connection as a message source.

...
上面的例子使用了 Modbus 模拟器进行数据采集， EMQX Neuron 支持 100+ 种工业协议。关于EMQX Neuron采集西门子 S7-1200 PLC数据并发送到MQTT的完整教程，请参考：[10 分钟将西门子 S7-1200 连接到 MQTT](https://www.emqx.com/zh/blog/connecting-siemens-s7-1200-plc-to-mqtt)
...
1. 在 MQTTX 中订阅 factory/alerts/high-temperature，当温度超过 80°C 时，你会收到告警消息。

...
本教程介绍使用 NeuronEX 通过 ADS 协议采集 Beckhoff PLC 上不同地址区域的数据。

## 环境介绍

本教程使用了在同一个局域网下的 2 台机器，机器 1 为 Linux 系统，安装了 NeuronEX 软件；机器 2 为 Windows 系统，安装了倍福 TwinCAT 3 软件。您可以前往 [Beckhoff TwinCAT 网站]下载和安装 TwinCAT 。
...
| 安装软件 | NeuronEX          | TwinCAT             |
| 网络     | 连通              | 连通                |

## 配置 TwinCAT

如希望在 NeuronEX 和 Beckhoff PLC 之间建立通讯，需要添加路由、查找 AMS Net ID、AMS port、以及变量的 index group 和 index offset 。
以下部分介绍详细配置。
...
输入下图红框内容，其中 **AmsNetId**，为 NeuronEX 所在机器与 Beckhoff PLC 相连的网卡的 IP 地址后加上 ".1.1" 。
...
在 NeuronEX 仪表板中，点击**南向设备管理 -> 添加设备**来添加一个 ADS 节点。
...
<figure align="center">
  ...
  <figcaption align = "center">
    <sub><b>Fig.13 - 在 NeuronEX 仪表板中添加 ADS 节点</b></sub>
  </figcaption>
</figure>
...
<figure align="center">
  ...
  <figcaption align = "center">
    <sub><b>Fig.14 - 在 NeuronEX 仪表板中配置 ADS 节点</b></sub>
  </figcaption>
</figure>
...
对于前文提及的 TwinCAT PLC 程序中的每个变量，我们将在 NeuronEX ADS 节点上添加一个相应的点位。
...
<figure align="center">
  ...
  <figcaption align = "center">
    <sub><b>Fig.17 - NeuronEX 仪表板中显示 ADS 节点点位</b></sub>
  </figcaption>
</figure>
...
在 NeuronEX 仪表板中，点击**数据监控**查看变量值读取正确。
...
<figure align="center">
  ...
  <figcaption align = "center">
    <sub><b>Fig.19 - NeuronEX 数据监控标签页</b></sub>
  </figcaption>
</figure>
...
在 NeuronEX **数据监控**标签页，在 *main.MXtest1* 点位上点击 **Write** 写入 true。
...
<figure align="center">
  ...
  <figcaption align = "center">
    <sub><b>Fig.20 - NeuronEX 写点位 main.MXtest1</b></sub>
  </figcaption>
</figure>
...
<figure align="center">
  ...
  <figcaption align = "center">
    <sub><b>Fig.21 - NeuronEX 写点位 main.MWtest1</b></sub>
  </figcaption>
</figure>

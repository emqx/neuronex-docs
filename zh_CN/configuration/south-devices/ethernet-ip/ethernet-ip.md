...
EMQX Neuron EtherNet/IP (CIP) 插件主要用于支持 EtherNet/IP 协议的设备。

## 添加插件

在 **数据采集 -> 南向设备**，点击**添加设备**来创建设备节点，输入插件名称，插件类型选择 **EtherNet/IP (CIP)** 启用插件。

## 设备配置

点击插件卡片或插件列，进入**设备配置**页。配置 EMQX Neuron 与设备建立连接所需的参数，下表为 EtherNet/IP (CIP) 相关的配置项。

...
EMQX Neuron Mitsubishi 4E 插件完全兼容 Mitsubishi SLMP (MC) 协议，主要用于通过以太网访问三菱的 PLC，如 iQ-F 系列（SLMP）和 IQ-R 系列：
...
在 **数据采集 -> 南向设备**，点击**添加设备**来创建设备节点，输入插件名称，插件类型选择 **Mitsubishi 4E** 启用插件。

...
本节主要介绍 EMQX Neuron 作为 Client，Modbus Slave 作为 Server 时，EMQX Neuron 与 Modbus Slave 的相关配置。

EMQX Neuron 作为 Client，主动向 Modbus Slave 发起连接请求，用户需要保证 EMQX Neuron -> Modbus Slave 的网络连通性。

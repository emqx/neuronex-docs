...
EMQX Neuron 集成了 OPC UA 服务器的地址空间浏览器功能，这个功能可以帮助用户获取已连接的 OPC UA 服务器中的数据点位（Tag）信息，包括 Tag 在服务器模型中的位置信息、Tag 的访问地址以及 Tag 的类型信息，并将这些 Tag 快速添加到采集组中。
...
4. 单选或多选 OPC UA 地址空间中的数据点位，点击**添加点位到采集组**按钮，将这些数据点位添加到采集组中。可选择现有采集组，也可创建新采集组。一次最多添加 10000 个点位。

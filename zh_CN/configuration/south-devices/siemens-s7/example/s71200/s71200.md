...
本文将使用 Siemens S7 ISOTCP 驱动连接西门子 S7-1200 PLC，实现读写 PLC 中的点位值。

![connect-s71200](./assets/c1200.jpg)

Siemens S7 ISOTCP 驱动可以通过本地局域网或者 Internet 连接 PLC，但需要注意，如果 PLC 与 EMQX Neuron 服务器不在同一局域网内，需要在 PLC 中配置端口映射。
...
## EMQX Neuron 配置节点连接 1200 PLC

* 在南向设备中，点击 **添加设备**， 选择驱动 **Siemens S7 ISOTCP** 来创建一个连接 1200 PLC 的节点。

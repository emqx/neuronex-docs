...
EMQX Neuron 数据处理模块提供了用于构建查询的各种元素。 总结如下。

| 元素                    | 总结                                                                                                                             |
|-----------------------|--------------------------------------------------------------------------------------------------------------------------------|
| [SELECT](#select)     | SELECT 用于从输入流中检索行，并允许从一个或多个输入流中选择一个或多个列。                                                                            |
...
从输入流中检索行，并允许从一个或多个输入流中选择一个或多个列。
...
指定任何支持的窗口，有关详细信息，请参阅 [windows](windows.md) 。
...
如果你想在 SQL 或者流管理中使用保留关键字，或者特殊字符，请参考 [词法元素](lexical_elements.md)。
